...
View.prototype.exercise1 = function () {
  ...
  $("li").addClass("orange"); //they both work!
...
View.prototype.exercise3 = function () {
  ...
  //Result: An <h1> with the text 'i love jquery' appears under the grid.
      ...
      h1.textContent = "This is injected by JavaScript";
      ul.appendChild(li);
  //your code here!
};
...
View.prototype.exercise4 = function () {
  ...
  $('square').textContent = ('Mike'); // wut? it's printing jeff on every other square
  //your code here!
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $('.square').on("click", e => { //creates a button
   const $sq = $(e.currentTarget);
   alert($sq.attr("data-pos")); //alerts the position
 });
};
...
View.prototype.exercise6 = function () {
  ...
  $('.square').each( (idx, el) => { //each square
    var $sq = $(el); //creates a jquery object from the square
    $sq.css("background-color", _randomColorString()); //sets the color
  })
...
View.prototype.exercise7 = function(){
  ...
  //your code here!
  $('#easel').on("mouseenter", ".square", e => { //sets up an event for square
    const $sq = $(e.currentTarget);
    console.log($sq.css("background-color")); //console logs the sqaures color
  });
};
