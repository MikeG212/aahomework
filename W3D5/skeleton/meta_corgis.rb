...
class MetaCorgiSnacks
  ...
  #I did not properly interpolate the variable name or understand how to use the send method
...
#Phase 2 Essentially the same as the first one, just creates a more specifically named method.
